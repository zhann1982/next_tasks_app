  ...
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-black flex flex-col gap-8 items-center justify-center p-4">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Join Next Tasks App</h1>
        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
          Create an account to manage your tasks and boost your productivity. It&apos;s quick and easy!
        </p>
      </div>
      <div className="w-full max-w-md bg-white/70 dark:bg-zinc-900/70 shadow-lg rounded-xl p-8 backdrop-blur">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Create an account</h1>
